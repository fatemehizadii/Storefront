...
from .serializers import (AddCartItemSerializer, CartItemSerializer, CartSerializer, CreateOrderSerializer,
                          ...
                          ProductSerializer, CollectionSerializer, ReviewSerializer, UpdateCartItemSerializer)
...
class OrderViewSet(ModelViewSet):
    ...
    # def get_serializer_context(self):                              we don't need this anymore because we don't use
    #     return {'user_id': self.request.user.id}                   create model mixin, and we override create method.
